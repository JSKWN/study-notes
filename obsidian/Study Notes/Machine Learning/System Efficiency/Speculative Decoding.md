...
- 내용 요약 (https://developer.nvidia.com/ko-kr/blog/an-introduction-to-speculative-decoding-for-reducing-latency-in-ai-inference/)
	...
	- Draft-Target 방식
		...
		- 동일한 데이터 분포로 학습된 소형 모델이, 초안(draft)를 생성. 소형 모델을 ‘드래프트 모델’이라고 표현![[obsidian/Attachments/speculative-decoding-draft-target-approach-0186.jpg]]
		- `드래프트 생성` → `병렬 검증` → `거절 샘플링` 단계를 거침
			...
			3. 거절 샘플링: 
			- ![[obsidian/Attachments/speculative-decoding-verification-phase-target-model.jpeg]]
...
- ![[obsidian/Attachments/Pasted image 20251201151828.png]]
